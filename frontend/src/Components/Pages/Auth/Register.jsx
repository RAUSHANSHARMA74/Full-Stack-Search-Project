...
export default function Register() {
    ...
    const handleSubmitRegister = async (event) => {
        ...
        let response = await postApi("/api/auth/register", register)
        Swal.fire({
            title: "Good job!",
        ...
        <div className="register_form h-[100vh] w-full bg-[#CADCFC]">
            <section className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <div className="p-12 mx-auto max-w-2xl lg:py-16 w-full border border-black dark:bg-gray-800 dark:border-gray-700 rounded-lg">
                    <h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-white">Sign up to your account</h2>
                    <form action="#" onSubmit={handleSubmitRegister}>
                        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <input type="password" value={register.password} onChange={handleChangeRegister} name="password" id="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Password" required="" />
                            </div>
                            ...
                            <div className='flex justify-between sm:col-span-2'>
                                ...
                                <Link to="/login" >
                                    <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500 text-blue-600">Sign in</a>
                                </Link>
                            </div>

                        </div>
                        <button type="submit" className="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-teal-600 hover:bg-teal-700 bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
                            Sign up
                        </button>
                    </form>
                </div>
